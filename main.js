...
win.on.resize.all( ( w , ev ) => {
    ...
    console.log( "resize event :" , w.get.title()  , ev.clientX );

});


let e = new element("e_id","simple text",10,10,110,120);

    e.context_menu(false);
    ...
    e.on.hover( 
        ( obj , event ) => console.log("hover !" , obj.get.text() )
    );
